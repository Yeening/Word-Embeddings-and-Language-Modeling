...
MODEL_PATH = "/content/drive/My Drive/Colab Notebooks/NLP/Word-Embeddings-and-Language-Modeling/weights/stacked_model.h5"
...
def predict_save(model, inputs, path):
    ...
    model = LSTMLanguageModel(len(vocabulary), num_layers=2)
...
model1 = LSTMLanguageModel(len(vocabulary), num_layers=2)
